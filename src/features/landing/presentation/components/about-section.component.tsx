...
export const AboutSection = () => {
  return (
    <section className="section-anchor relative w-full overflow-hidden bg-background-dark py-20 sm:py-28">
      ...
      <div className="relative z-10 container mx-auto max-w-screen-xl px-4">
          ...
          {aboutSectionData.features.map((feature, index) => {
            ...
            return (
              <div
                key={index}
                className="
                  flex flex-col rounded-2xl border border-border-color bg-background-light p-8
                  transition-all duration-300 ease-in-out
                  hover:-translate-y-2
                  hover:border-brand-blue/50
                  hover:shadow-2xl hover:shadow-brand-blue/10
                "
              >
