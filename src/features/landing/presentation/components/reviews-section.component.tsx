                    ...
                    >
                        <div className="embla__container">
                            {screenshots.map((item) => (
                                <div className="embla__slide flex-[0_0_80%] sm:flex-[0_0_50%] md:flex-[0_0_40%] lg:flex-[0_0_30%] px-4" key={item.id}>
                                    <div className="aspect-[9/16] w-full rounded-2xl border-2 border-border-color bg-background-light p-2 shadow-2xl shadow-black/30 transition-transform duration-300 hover:scale-[1.03] hover:shadow-brand-blue/20">
                                        <div className="h-full w-full rounded-lg bg-border-color/50 flex items-center justify-center">
                                            <p className="text-text-secondary text-sm">Скриншот #{item.id}</p>
                                        </div>
                                    </div>
                                </div>
                            ))}
